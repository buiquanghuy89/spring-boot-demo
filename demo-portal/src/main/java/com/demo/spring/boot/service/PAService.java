...
public interface PAService {
    public List<Module> getDataByDay(String moduleName, String strToDate, String strFromDate);

    public List<Module> getAllDataByDay(String strToDate, String strFromDate);
